metadata {
    ...
    preferences() {
        section("Query Inputs"){
            ...
            input "pollInterval", "enum", title: "Auto Poll Interval:", required: false, defaultValue: "1 Minute", options: ["1 Second", "5 Seconds", "10 Seconds", "15 Seconds", "30 Seconds", "1 Minute", "3 Minutes"];
        }
    }
}
